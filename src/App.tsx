...
function App() {
  return (
    <div>
      {/* 1. 타이포그래프 -> 텍스트 설정 */}
      {/* 고정된 값 말고 지정하고 싶으면 font-[value] */}
      <div className="text-xs text-red-500">text-xs(원색은 명도 500 정도)</div>
      ...
      <div className="flex flex-row items-start justify-evenly">
        ...
        <div className="p h-20 w-10 flex-1 border">2</div>
